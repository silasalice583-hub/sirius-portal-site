...
def write_cover(spec: ArticleSpec, index: int) -> str:
  ...
  <text x="128" y="816" fill="{palette[2]}" font-family="Microsoft YaHei, sans-serif" font-size="24" letter-spacing="5">天狼星门户</text>
</svg>'''
...
def main() -> None:
    ...
    # “待补充”目录中的这 17 篇是当前网站保留的完整文章集。
    # 不再合并旧 articles-data.js，避免已清理的历史文章重新出现。
    merged = articles
